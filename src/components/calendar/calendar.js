  ...
  events: [
    {
      ...
      endTime: "10:00",
      color: "blue",
      description: "Họp nhóm bàn về tiến độ dự án",
    },
    {
      id: 2,
      title: "Deadline",
      ...
      endTime: "17:00",
      color: "red",
      description: "Deadline nộp dự án",
    },
    {
      id: 3,
      title: "Demo",
    ...
    },
    {
      ...
      endTime: "11:00",
      color: "purple",
      description: "Review code với team",
    },
  ],
  nextId: 5,
};
...
function renderCalendarGrid() {
  const { daysInMonth, startingDayOfWeek, year, month } = getMonthDays(
  ...
  for (let i = 0; i < startingDayOfWeek; i++) {
    html +=
      '<div class="aspect-square p-2 border border-gray-100 bg-gray-50 rounded-lg"></div>';
  }
        ...
        <div id="calendar-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
                ...
                <div class="space-y-3 max-h-60 overflow-y-auto mb-6">
                    ${
                      events.length === 0
                        ? '<p class="text-gray-500 text-center py-4">Không có sự kiện nào trong ngày này</p>'
                        : events
                            .map(
                              (event) => `
                ...
                <div class="space-y-3">
                    ${
                      upcomingEvents.length === 0
                        ? '<p class="text-gray-500 text-center py-4">Không có sự kiện nào</p>'
                        : upcomingEvents
                            .map(
                              (event) => `
